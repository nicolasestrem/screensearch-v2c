...
> cited-frame tiles) in the [point-in-time PR audits](./docs/audits/) (e.g.
[`AUDIT_0.2.0_PR7_2026-06-25.md`](./docs/audits/AUDIT_0.2.0_PR7_2026-06-25.md)). **Packaging**
...
> **P5 verification** (per the [point-in-time PR audits](./docs/audits/)): all six screens
...
docs/
  ...
  audits/                  point-in-time PR audit evidence
