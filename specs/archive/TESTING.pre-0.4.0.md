# Testing archive — manual acceptance checklists (pre-0.4.0)

Per-PR manual acceptance sections for the 0.2.x through 0.3.2 arcs, moved out of the live
`docs/TESTING.md` on 2026-07-11 to match the archive-on-release convention used for the build-loop
logs (`specs/05`-`08`). These features have all shipped; the sections are preserved here for
history. The live `docs/TESTING.md` keeps the evergreen CI-order gates plus the current-arc
(0.4.0) sections.
