# 08 — AI Changelog · v0.2.x archive (shipped entries, 0.2.0–0.2.2)

> Archived 0.2.x AI-changelog entries moved out of `specs/08_CHANGELOG_AI.md` on the post-v0.2.2
> archival sweep (2026-06-30). Entries preserved verbatim, newest-first. The live file holds only
> the current (post-0.2.2) arc. Pre-0.2.x history is in `08_CHANGELOG_AI.v0.1.0.md`.
