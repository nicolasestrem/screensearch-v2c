# 08 — AI Changelog — archived v0.3.2 history (P7.2 product-shell mini-arc)

> Archived on the v0.3.2 release sweep (2026-07-06, 0.3.2 PR6); entries preserved verbatim from
> the live `specs/08_CHANGELOG_AI.md` (newest first): PR6 audit + release sweep; PR5 Settings
> two-tier IA + review follow-up; PR4 shell-layout hardening; PR3 systray + quick actions +
> review follow-up; PR2 auto-update; PR1 specs contract.
