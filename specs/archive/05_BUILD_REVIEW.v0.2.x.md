# 05 — Build Review · v0.2.x archive (shipped passes, 0.2.0–0.2.2)

> Archived 0.2.x build-review passes moved out of `specs/05_BUILD_REVIEW.md` on the post-v0.2.2
> archival sweep (2026-06-30). Entries preserved verbatim, newest-first. The live file holds only
> the current (post-0.2.2) arc. Pre-0.2.x history is in `05_BUILD_REVIEW.v0.1.0.md`.
