...
export function useLiveEvents() {
  ...
  useEffect(() => {
    ...
    // job_progress is a worker progress snapshot emitted after a job finalizes.
    // Update the live queue counter immediately, then debounce-invalidate the data
    // a *completed* job changed:
