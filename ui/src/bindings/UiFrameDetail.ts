 ...
 */
export type UiFrameDetail = { session: SessionReference | null, frame_id: number, captured_at: number, monitor_index: number, width: number, height: number, image_path: string, 
/**
