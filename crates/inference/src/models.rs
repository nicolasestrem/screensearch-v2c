...
/// to a 1280 px longest edge before tagging (`vision::encode_data_url`; 1568 until the #64
/// throughput fix restored pre-WebP request parity — 0.3.1 PR2), which bounds the worst
